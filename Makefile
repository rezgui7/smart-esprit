...
pkgdatadir = $(datadir)/jojo
pkgincludedir = $(includedir)/jojo
pkglibdir = $(libdir)/jojo
pkglibexecdir = $(libexecdir)/jojo
...
am_jojo_OBJECTS = main.$(OBJEXT) support.$(OBJEXT) interface.$(OBJEXT) \
	callbacks.$(OBJEXT) gestion.$(OBJEXT)
jojo_OBJECTS = $(am_jojo_OBJECTS)
am__DEPENDENCIES_1 =
jojo_DEPENDENCIES = $(am__DEPENDENCIES_1)
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(jojo_SOURCES)
DIST_SOURCES = $(jojo_SOURCES)
...
ACLOCAL = ${SHELL} /home/youssef/Desktop/jojo/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/youssef/Desktop/jojo/missing autoconf
AUTOHEADER = ${SHELL} /home/youssef/Desktop/jojo/missing autoheader
AUTOMAKE = ${SHELL} /home/youssef/Desktop/jojo/missing automake-1.15
AWK = mawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/youssef/Desktop/jojo/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/youssef/Desktop/jojo/src
abs_srcdir = /home/youssef/Desktop/jojo/src
abs_top_builddir = /home/youssef/Desktop/jojo
abs_top_srcdir = /home/youssef/Desktop/jojo
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/youssef/Desktop/jojo/install-sh
...
jojo_LDADD = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype $(INTLLIBS)
all: all-am
...
jojo$(EXEEXT): $(jojo_OBJECTS) $(jojo_DEPENDENCIES) $(EXTRA_jojo_DEPENDENCIES) 
	@rm -f jojo$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(jojo_OBJECTS) $(jojo_LDADD) $(LIBS)
